...
class CircleRotation(Scene):
    def construct(self):
        ...
        #self.add_sound("The SAT Question Everyone Got Wrong [FUHkTs-Ipfg].mp3")
        ...
        coin_1_circle = Circle(radius=1.1)
        coin_2_circle = Circle(radius=1.1).next_to(coin_1_circle, UP, buff=0)
        ...
        self.play(Transform(circle_r, coin_1_circle), Transform(circle_r_by_3, coin_2_circle), run_time=1.5)
        self.play(FadeOut(circle_r), FadeOut(circle_r_by_3), FadeIn(coin_1), FadeIn(coin_2), run_time=1)
